...
namespace MVCCRUD.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Index(string buscar, string filtro)
        {
            ...
            {
                usuarios = usuarios.Where(a => a.Nombre!.Contains(buscar));
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Fecha,Correo")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Fecha,Correo")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
